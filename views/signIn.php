...
<body>
    ...
    <form action="index.php?action=signInVerif" method="post" class="signIn">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="pseudo" id="pseudo" aria-describedby="emailHelp" placeholder="jboneau">
    ...
    <form action="index.php?action=signUp" method="post" class="signUp" style="display: none">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control fisrtName" aria-describedby="emailHelp" placeholder="Exemple: Jean" name="prenom">
            </div>
        </div>
        <div class="form-group row">
            <label for="lastName" class="control-label col-sm-2 col-form-label">Nom:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="lastName" aria-describedby="emailHelp" placeholder="Exemple: Bonneau" name="nom">
            </div>
        </div>
        <div class="form-group row">
